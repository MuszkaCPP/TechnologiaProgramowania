...
public class ReportGeneratorTest extends AbstractReportingTest{
	...
	public void testCreateJSONReport() {
		...
		Report generatedReport = new ReportGenerator().generateReport(reportData, reportType.JSON);
	...
	public void testCreateXMLReport() {
		ReportData reportData = createDummyReportData();
		Report generatedReport = new ReportGenerator().generateReport(reportData, reportType.XML);
	...
	public void testCreateHTMLReport() {
		ReportData reportData = createDummyReportData();
		Report generatedReport = new ReportGenerator().generateReport(reportData, reportType.HTML);
	...
	public void testCreatePDFReport() {
		ReportData reportData = createDummyReportData();
		Report generatedReport = new ReportGenerator().generateReport(reportData, reportType.PDF);
