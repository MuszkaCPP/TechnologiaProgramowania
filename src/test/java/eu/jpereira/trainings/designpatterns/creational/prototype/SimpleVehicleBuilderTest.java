...
public class SimpleVehicleBuilderTest {
	...
	@Test
	public void cloneTest() throws CloneNotSupportedException, NeedToPackLastVehicleException, VehicleDoesNotHavePartsException, CouldNotCloneLastObjectException, CannotHaveZeroPartsException{
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
		Vehicle vehicle = builder.createVehicle().packIt();
		Vehicle hevTester = builder.createVehicle().with(new Tire()).times(5).packIt();
		Vehicle _vehicle = (Vehicle) vehicle.clone();
		
		vehicle.setParts(hevTester.getAllParts());
		
		assertNotSame(_vehicle.countParts(),vehicle.countParts());
		
	}
	
	
	@Test
	public void testCreateVehicle() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException, CloneNotSupportedException {

		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
		Vehicle vehicle = builder.createVehicle().packIt();
		assertEquals(0, ((Vehicle) vehicle.clone()).countParts());

	}
	@Test
	public void testTimesOne() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException, CouldNotCloneLastObjectException, CannotHaveZeroPartsException, CloneNotSupportedException {
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
		Vehicle vehicle = builder.createVehicle().with(new Tire()).times(1).packIt();
		assertEquals(1, ((Vehicle) vehicle.clone()).countParts());
	...
	@Test
	public void testTimesMany() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException, CouldNotCloneLastObjectException, CannotHaveZeroPartsException, CloneNotSupportedException {
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
		Vehicle vehicle = builder.createVehicle().with(new Tire()).times(10).packIt();
		assertEquals(10, ((Vehicle) vehicle.clone()).countParts());		
	}
	
	@Test
	public void testTimesManyDifferent() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException, CouldNotCloneLastObjectException, CannotHaveZeroPartsException, CloneNotSupportedException {
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
		Vehicle vehicle = builder.createVehicle().with(new Tire()).times(10).with(new Window()).times(2).with(new Shell()).packIt();
		assertEquals(13, ((Vehicle) vehicle.clone()).countParts());		
