...
public class BookStoreFacadeTest extends AbstractClientTest {
	...
	protected BookstoreFacade createFacade() {
		...
		DefaultBookstoreFacade _facade = new DefaultBookstoreFacade();
		_facade.setBookDBService(bookService);
		_facade.setCustomerNotificationService(customerNotificationService);
		_facade.setCustomerService(customerService);
		_facade.setOrderingService(orderingService);
		_facade.setWharehouseService(warehouseService);
