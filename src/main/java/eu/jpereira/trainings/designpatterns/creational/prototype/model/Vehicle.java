...
public class Vehicle implements Cloneable {
	...
	public Object clone() throws CloneNotSupportedException {
		  ...
		  List<VehiclePart> copiedParts = new ArrayList<VehiclePart>();
		  
	        for(VehiclePart _part : parts) {
	            copiedParts.add(_part.clone());
	        }
	        
	        Vehicle _vehicle = (Vehicle) super.clone();
	        _vehicle.setParts(copiedParts);
