...
public class Report {
	 ...
	 * @param string
	 */
	public Report(ReportAbstractFactory _abstractFactory) {
		this.setBody(_abstractFactory.createReportBody());
		this.setFooter(_abstractFactory.createReportFooter());
		this.setHeader(_abstractFactory.createReportHeader());
	}
